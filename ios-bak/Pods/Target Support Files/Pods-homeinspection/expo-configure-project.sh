...
with_node \
  ...
  --target "/Users/minhluc/Workspace/OneTech/Projects/HomeInspection/home-inspection/ios/Pods/Target Support Files/Pods-homeinspection/ExpoModulesProvider.swift" \
  --entitlement "/Users/minhluc/Workspace/OneTech/Projects/HomeInspection/home-inspection/ios/homeinspection/homeinspection.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-system-ui" "expo-web-browser"
